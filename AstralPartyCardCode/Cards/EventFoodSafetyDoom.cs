...
public class EventFoodSafetyDoom : AstralPartyCardModel
{
    ...
    protected override string PortraitBasePath => "res://AstralPartyMod/images/card_portraits/event_food_safety";
    protected override string FrameBasePath => "res://AstralPartyMod/images/card_portraits/event_food_safety";
