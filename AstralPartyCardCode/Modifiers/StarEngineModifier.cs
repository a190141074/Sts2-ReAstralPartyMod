...
{
    public const string ModifierId = "ASTRALPARTYMOD-STAR_ENGINE_MODE";
    ...
    protected override string IconPath => "res://AstralPartyMod/images/astral_token.png";
