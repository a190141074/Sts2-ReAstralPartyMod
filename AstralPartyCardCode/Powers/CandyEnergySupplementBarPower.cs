...
public class CandyEnergySupplementBarPower : AstralPartyPowerModel
{
    ...
    public override LocString Title =>
        new("powers", "ASTRALPARTYMOD-CANDY_ENERGY_SUPPLEMENT_BAR_POWER.title");

    public override LocString Description =>
        new("powers", "ASTRALPARTYMOD-CANDY_ENERGY_SUPPLEMENT_BAR_POWER.description");

    protected override string SmartDescriptionLocKey =>
        "ASTRALPARTYMOD-CANDY_ENERGY_SUPPLEMENT_BAR_POWER.smartDescription";
