...
public class PersonalityDerivativeProprietressWealthism : AstralPartyRelicModel
{
    ...
    {
        var title = new LocString("relics",
            "RE_ASTRAL_PARTY_MOD_RELIC_PERSONALITY_DERIVATIVE_PROPRIETRESS_WEALTHISM.stats_title");
        var bodyTemplate = new LocString("relics",
                "RE_ASTRAL_PARTY_MOD_RELIC_PERSONALITY_DERIVATIVE_PROPRIETRESS_WEALTHISM.stats_description")
            .GetRawText();
