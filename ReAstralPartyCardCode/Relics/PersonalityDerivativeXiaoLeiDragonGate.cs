...
public class PersonalityDerivativeXiaoLeiDragonGate : AstralPartyRelicModel
{
    ...
    private HoverTip BuildProgressHoverTip()
    {
        var title = new LocString(
            "relics",
            "RE_ASTRAL_PARTY_MOD_RELIC_PERSONALITY_DERIVATIVE_XIAO_LEI_DRAGON_GATE.progress_title");
        var template = new LocString(
            "relics",
            "RE_ASTRAL_PARTY_MOD_RELIC_PERSONALITY_DERIVATIVE_XIAO_LEI_DRAGON_GATE.progress_description").GetRawText();
        var unlockedText = new LocString(
            "relics",
            IsUnlocked
                ? "RE_ASTRAL_PARTY_MOD_RELIC_PERSONALITY_DERIVATIVE_XIAO_LEI_DRAGON_GATE.unlocked"
                : "RE_ASTRAL_PARTY_MOD_RELIC_PERSONALITY_DERIVATIVE_XIAO_LEI_DRAGON_GATE.locked").GetRawText();
