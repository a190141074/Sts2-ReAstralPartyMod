...
public static class ExclusiveRelicUnlockHelper
{
    ...
    [
        ...
        ModelDb.Relic<EnigmaticEnderPearl>(),
        ModelDb.Relic<EnigmaticBlazeRod>(),
        ModelDb.Relic<EnigmaticSynthesisBlazePowder>(),
        ModelDb.Relic<EnigmaticSynthesisEnderEye>(),
        ModelDb.Relic<EnigmaticSynthesisEnderRod>(),
