...
public class BaseAbilityMonsterLaser : BaseAbilityCardModel
{
    ...
    public BaseAbilityMonsterLaser() : base(0, CardType.Skill, CardRarity.Rare, TargetType.AnyEnemy)
    {
    }
