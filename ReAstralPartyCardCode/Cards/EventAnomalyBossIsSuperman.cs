...
[RegisterCard(typeof(AstralEventCardPool), Order = 205)]
public class EventAnomalyBossIsSuperman : AstralPartyCardModel
{
    ...
    public EventAnomalyBossIsSuperman() : base(0, CardType.Skill, CardRarity.Rare, TargetType.Self)
    {
    }
