...
public class IAmDragonTemporaryStrengthLossPower : AstralPartyPowerModel
{
    ...
    public override LocString Title =>
        new("powers", "RE_ASTRAL_PARTY_MOD_POWER_I_AM_DRAGON_TEMPORARY_STRENGTH_LOSS_POWER.title");
    ...
    public override LocString Description
    {
        get
        {
            var description = new LocString("powers",
                "RE_ASTRAL_PARTY_MOD_POWER_I_AM_DRAGON_TEMPORARY_STRENGTH_LOSS_POWER.description");
    ...
    protected override string SmartDescriptionLocKey =>
        "RE_ASTRAL_PARTY_MOD_POWER_I_AM_DRAGON_TEMPORARY_STRENGTH_LOSS_POWER.smartDescription";
