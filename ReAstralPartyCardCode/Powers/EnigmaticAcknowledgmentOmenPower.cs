...
public class EnigmaticAcknowledgmentOmenPower : EnigmaticOmenPowerBase
{
    protected override int DefaultTurns => 1;

    protected override string EffectDescriptionLocKey =>
        "RE_ASTRAL_PARTY_MOD_POWER_ENIGMATIC_ACKNOWLEDGMENT_OMEN_POWER.effect";
    ...
    protected override async Task OnTriggered(PlayerChoiceContext choiceContext, Player player)
    {
        ...
        var card = player.Creature.CombatState.CreateCard(ModelDb.Card<EnigmaticTheAcknowledgment>(), player);
