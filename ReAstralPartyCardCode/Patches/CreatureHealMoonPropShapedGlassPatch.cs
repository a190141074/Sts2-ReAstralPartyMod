...
public sealed class CreatureHealMoonPropShapedGlassPatch : IPatchMethod
{
    public static string PatchId => "creature_heal_moon_prop_shaped_glass";
    public static string Description => "Clamp current HP to 50% after healing while Moon Prop Shaped Glass is active";
