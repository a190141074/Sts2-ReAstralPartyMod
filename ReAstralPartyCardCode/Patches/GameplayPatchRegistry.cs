    ...
    private static void RegisterGameplayPatches(ModPatcher patcher)
    {
        ...
        [
            new ModPatchInfo(
                ...
                isCritical: false,
                description: "Multiplayer patch: expand serialized lobby player slot width for 12-player support"),
            new ModPatchInfo(
                ...
                isCritical: false,
                description: "Multiplayer patch: expand deserialized lobby player slot width for 12-player support"),
            new ModPatchInfo(
                ...
                isCritical: false,
                description: "Multiplayer patch: expand lobby join player-list width for 12-player support"),
            new ModPatchInfo(
            ...
            new ModPatchInfo(
                ...
                isCritical: false,
                description: "Multiplayer patch: expand begin-run player-list width for 12-player support"),
            new ModPatchInfo(
