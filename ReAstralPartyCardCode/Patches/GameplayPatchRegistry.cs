...
internal static class GameplayStaticPatchCatalog
{
    ...
    private static void RegisterUiPatches(ModPatcher patcher)
    {
        ...
        [
            ...
            new ModPatchInfo(
                "attack_potion_warforge_compat_patch",
                typeof(MegaCrit.Sts2.Core.Models.Potions.AttackPotion),
                "OnUse",
                typeof(AttackPotionWarforgeCompatPatch),
                false,
                "Gameplay patch: let Attack Potion include Warforge-enhanced Skill cards",
            ...
            new ModPatchInfo(
                "skill_potion_warforge_compat_patch",
                typeof(MegaCrit.Sts2.Core.Models.Potions.SkillPotion),
                "OnUse",
                typeof(SkillPotionWarforgeCompatPatch),
                false,
    ...
    private static void RegisterGameplayPatches(ModPatcher patcher)
    {
        ...
        [
            ...
            new ModPatchInfo(
                "tetra_warforge_enchantment_should_receive_hooks_patch",
                typeof(CardModel),
                nameof(CardModel.ShouldReceiveCombatHooks),
                typeof(TetraWarforgeEnchantmentShouldReceiveCombatHooksPatch),
                false,
                "Gameplay patch: force cards with Warforge to receive combat hooks",
                harmonyMethodType: MethodType.Getter),
            new ModPatchInfo(
                "tetra_warforge_enchantment_after_card_played_patch",
                typeof(AbstractModel),
                nameof(CardModel.AfterCardPlayed),
                typeof(TetraWarforgeEnchantmentAfterCardPlayedPatch),
                false,
                "Gameplay patch: resolve Warforge post-play bonus effects"),
            new ModPatchInfo(
                "tetra_warforge_enchantment_modify_damage_patch",
                typeof(AbstractModel),
                nameof(CardModel.ModifyDamageAdditive),
                typeof(TetraWarforgeEnchantmentModifyDamagePatch),
                false,
                "Gameplay patch: apply Warforge attack damage penalty"),
            new ModPatchInfo(
                "tetra_warforge_enchantment_modify_block_patch",
                typeof(AbstractModel),
                nameof(CardModel.ModifyBlockAdditive),
                typeof(TetraWarforgeEnchantmentModifyBlockPatch),
                false,
                "Gameplay patch: apply Warforge skill block penalty"),
            new ModPatchInfo(
                "tetra_warforge_enchantment_extra_card_text_patch",
                typeof(EnchantmentModel),
                nameof(EnchantmentModel.DynamicExtraCardText),
                typeof(TetraWarforgeEnchantmentExtraCardTextPatch),
                false,
                "UI patch: resolve Warforge extra card text by live card type",
                harmonyMethodType: MethodType.Getter),
            new ModPatchInfo(
