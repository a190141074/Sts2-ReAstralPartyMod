...
public sealed class CreatureSetCurrentHpMoonPropShapedGlassPatch : IPatchMethod
{
    public static string PatchId => "creature_set_current_hp_moon_prop_shaped_glass";
    public static string Description => "Clamp current HP to 50% after SetCurrentHp while Moon Prop Shaped Glass is active";
