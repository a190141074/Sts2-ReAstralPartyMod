...
internal static class LucidDreamMaliceRuntimeHelper
{
    ...
    private static readonly System.Runtime.CompilerServices.ConditionalWeakTable<IRunState, Dictionary<string, PitchBlackImpulseSequenceState>>
        PitchBlackImpulseSequences = new();
    private static readonly System.Collections.Concurrent.ConcurrentDictionary<Player, decimal> BubblePotionSuppressedHealByPlayer = new();
